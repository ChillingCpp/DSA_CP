...
## CỤM 4 – SEGMENT TREE + PBS (17/2 → 23/2)

**17/2**: Segment Tree lazy – range update array

**18/2**: Segment Tree lazy – tiếp

**19/2**: Segment Tree lazy trên tree (nhận dạng)

**20/2**: Parallel Binary Search – ý tưởng

**21/2**: Parallel Binary Search – ứng dụng
