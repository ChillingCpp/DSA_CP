...
(Explicit choice hoặc implicit / hidden choice đều tính)
...
Có câu hỏi ngầm: “nên đi hướng nào?”

II. DP KHÔNG DỰA VÀO LỰA CHỌN

(State-evolution DP – không nhánh)
...
🔥 Phản ví dụ: khi nào DP tưởng không có lựa chọn nhưng thực ra có
